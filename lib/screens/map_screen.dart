...
class _MapScreenState extends State<MapScreen> {
  ...
  final String _orsApiKey =
      '5b3ce3597851110001cf624822a2c9301433415889356c2c851a3ca3'; // OpenRouteService API

  // 👇 Replace with your friend's Firebase Realtime Database URL
  final String _firebaseDbUrl =
      'https://chronova-c675c-default-rtdb.asia-southeast1.firebasedatabase.app/'; // <-- replace this
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('OpenStreetMap with Live Location'),
